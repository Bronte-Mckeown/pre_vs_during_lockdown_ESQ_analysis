...
fp = "lmm_thoughts_sample_social_agegroup_group_centered_age.txt"
...
myfile2 <- file.path(results_dir,"sample_social_agegroup_summary_tables")
...
myfile3 <- file.path(results_dir,"sample_social_agegroup_anova_tables")
...
fp2 <- "lmm_thoughts_sample_social_agegroup_group_centered_age_posthoc.txt"
